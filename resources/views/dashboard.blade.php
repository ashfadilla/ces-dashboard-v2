...
<body class="lg:px-28 px-6 lg:pt-12 pt-8 bg-[#F4F7F3]">
    <section class="flex items-center justify-between">
        <div class="flex items-center gap-8">
            ...
            <div>
                <div class="flex items-center gap-4">
                    <img src="{{ asset('assets/logo/ces-logo.png') }}" alt="Logo" class="lg:block hidden w-12 h-13">
                    <div>
    ...
    <section id="horizontal-bar" class="my-7 rounded-2xl bg-[#FFFFF0] overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-6 px-7 lg:px-7 border-b border-slate-100">
            ...
            {{-- Kanan: Tombol --}}
            <a id="active_message_button" href="{{ route('pumpActivation', 'lab-scale') }}"
    ...
    <section class="grid grid-cols-1 lg:grid-cols-3 gap-5 text-[#979797]">
        <div class="bg-[#FFFFF0] rounded-[20px] p-10">
            ...
            <div class="flex justify-between">
                ...
                <h1><span id="status">{{ $latest->status ? "Nyala" : "Mati" }}</span></h1>
            </div>
        </div>
...
<script>
    ...
    const maxValue = 200000; // Nilai maksimum
